...
function fileFinder(directories, targetFile) {
    ...
    for (var direct in directories) {
        if ( direct === targetFile) {
            return true;
        } else if (directories[direct] instanceof Object) {
            let check = fileFinder(directories[direct], targetFile);
...
function pathFinder(directories, targetFile) {
    ...
    for (var direct in directories) {
        if (direct === targetFile) {
            ...
            let check = pathFinder(directories[direct], targetFile);
            if (check !== null) {
                path += direct + check;
                return path;
            } 
